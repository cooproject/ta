...
<div align="center" style="margin-top: 30px">
		...
		<div class="form_settings">
			<table>
				...
				<tr>
					...
					<td width="400"><input type="text" name="title" value="<?php echo $data['service_title']; ?>" required="required" /></td>
				</tr>
				<tr>
	...
	<div style="width: 550px"><textarea name="content" id="content" ><?php echo $data['service_content']; ?></textarea></div>
